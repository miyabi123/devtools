...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    shortDesc: 'Convert text between camelCase, snake_case, and more',
    longDesc: 'Free online text case converter. Convert any text between camelCase, PascalCase, snake_case, kebab-case, SCREAMING_SNAKE_CASE, Title Case, Sentence case, lowercase, and UPPERCASE instantly. Perfect for developers renaming variables, functions, and database columns, or writers formatting headings. Paste your text and copy the result in any format with one click. All conversion runs 100% client-side — your text never leaves your browser.',
    category: 'dev',
    keywords: [
      'text case converter', 'camelcase converter', 'snake case converter', 'kebab case converter',
      'pascalcase converter', 'text transform online', 'case converter online',
      'camel case to snake case', 'string case converter', 'screaming snake case',
    ],
    howTo: [
      'Paste or type your text into the input field',
      'All case formats are converted instantly as you type',
      'Click Copy next to any format to copy it to clipboard',
      'Use the input format selector if your input is already camelCase or snake_case',
    ],
    faq: [
      { q: 'What is camelCase?', a: 'camelCase starts with a lowercase letter and capitalizes the first letter of each subsequent word, e.g. myVariableName. Commonly used in JavaScript, Java, and Swift.' },
      { q: 'What is the difference between snake_case and kebab-case?', a: 'snake_case uses underscores as separators (common in Python, Ruby, SQL). kebab-case uses hyphens (common in CSS, URLs, and HTML attributes).' },
      { q: 'What is PascalCase?', a: 'PascalCase (also called UpperCamelCase) capitalizes the first letter of every word including the first, e.g. MyClassName. Common in C#, TypeScript class names, and React components.' },
      { q: 'What is SCREAMING_SNAKE_CASE?', a: 'SCREAMING_SNAKE_CASE is snake_case in all uppercase, e.g. MAX_RETRY_COUNT. Conventionally used for constants and environment variables.' },
    ],
    related: ['word-counter', 'lorem-ipsum-generator', 'diff-checker'],
    isNew: true,
  },
  {
    slug: 'pdf-base64',
  ...
  },
  {
    ...
    shortDesc: 'ตรวจสอบเลขบัตรประชาชนไทย 13 หลัก',
    longDesc: 'เครื่องมือตรวจสอบความถูกต้องของเลขประจำตัวประชาชนไทย 13 หลัก ฟรี ออนไลน์ ใช้ algorithm checksum มาตรฐานกรมการปกครอง ตรวจสอบทันทีว่าเลขบัตรถูกต้องตามโครงสร้างหรือไม่ พร้อมอธิบายความหมายของแต่ละหมวดหมู่ในเลข 13 หลัก ประมวลผลทั้งหมดในเบราว์เซอร์ ไม่มีการส่งข้อมูลออกไปยังเซิร์ฟเวอร์ใดๆ — Free Thai national ID number validator using the official checksum algorithm.',
    category: 'thai',
    keywords: [
      'ตรวจสอบเลขบัตรประชาชน', 'เลขบัตรประชาชน 13 หลัก', 'thai id validator',
      'ตรวจ บัตรประชาชน', 'เลขประจำตัวประชาชน', 'thai national id',
      'บัตรประชาชน checksum', 'ตรวจสอบเลขประชาชน', 'thai id card number check',
    ],
    howTo: [
      'กรอกเลขบัตรประชาชน 13 หลักในช่องป้อนข้อมูล',
      'ระบบตรวจสอบความถูกต้องทันทีโดยใช้ algorithm checksum มาตรฐาน',
      'ดูผลลัพธ์ว่าเลขถูกต้องหรือไม่ พร้อมคำอธิบายโครงสร้างเลข',
      'ข้อมูลไม่ถูกส่งออกไปยังเซิร์ฟเวอร์ใดๆ ปลอดภัย 100%',
    ],
    faq: [
      { q: 'algorithm ที่ใช้ตรวจสอบคืออะไร?', a: 'ใช้ algorithm checksum มาตรฐานของกรมการปกครอง โดยนำตัวเลข 12 หลักแรกมาคูณกับน้ำหนัก 13 ลงมาถึง 2 แล้วหารเศษด้วย 11 เปรียบเทียบกับหลักที่ 13' },
      { q: 'ถ้าผ่าน validation แปลว่าเลขนั้นมีอยู่จริงไหม?', a: 'ไม่ใช่ครับ การตรวจสอบนี้ตรวจแค่โครงสร้างและ checksum เท่านั้น ไม่ได้เชื่อมต่อฐานข้อมูลกรมการปกครอง เลขที่ผ่านอาจไม่มีตัวตนจริงก็ได้' },
      { q: 'ข้อมูลเลขบัตรปลอดภัยไหม?', a: 'ปลอดภัย 100% ครับ ทุกอย่างประมวลผลในเบราว์เซอร์ของคุณเท่านั้น ไม่มีการส่งข้อมูลออกไปยังเซิร์ฟเวอร์ใดๆ' },
    ],
    related: ['thai-baht-to-words', 'thai-number-to-text', 'thai-tax-calculator'],
    isNew: true,
  },
  {
    slug: 'thai-vat-calculator',
    name: 'Thai VAT Calculator',
    shortDesc: 'คำนวณ VAT 7% — บวกเพิ่มและถอด VAT ออก',
    longDesc: 'เครื่องมือคำนวณภาษีมูลค่าเพิ่ม (VAT) 7% ฟรี ออนไลน์ รองรับทั้งการบวก VAT เข้าไปในราคา (ราคาไม่รวม VAT → ราคารวม VAT) และการถอด VAT ออกจากราคา (ราคารวม VAT → ราคาก่อน VAT) คำนวณทันทีพร้อมแสดงรายละเอียดครบ ได้แก่ ราคาก่อน VAT ยอด VAT และราคารวม VAT เหมาะสำหรับผู้ประกอบการ นักบัญชี และบุคคลทั่วไปในการออกใบกำกับภาษีและตรวจสอบยอดเงิน ประมวลผลทั้งหมดในเบราว์เซอร์ — Free Thai VAT 7% calculator supporting both add VAT and extract VAT modes.',
    category: 'thai',
    keywords: [
      'คำนวณ vat', 'vat 7 calculator', 'ถอด vat', 'บวก vat',
      'thai vat calculator', 'ภาษีมูลค่าเพิ่ม 7', 'คำนวณภาษีมูลค่าเพิ่ม',
      'vat included calculator', 'ราคารวม vat', 'ราคาไม่รวม vat',
    ],
    howTo: [
      'เลือกโหมด: บวก VAT (ราคายังไม่รวม VAT) หรือ ถอด VAT (ราคารวม VAT แล้ว)',
      'กรอกจำนวนเงินที่ต้องการคำนวณ',
      'ผลลัพธ์แสดงทันที — ราคาก่อน VAT, ยอด VAT 7%, และราคารวม VAT',
      'คัดลอกผลลัพธ์ที่ต้องการด้วยปุ่ม copy',
    ],
    faq: [
      { q: 'VAT ในไทยคืออะไร?', a: 'VAT (Value Added Tax) หรือภาษีมูลค่าเพิ่ม คือภาษีทางอ้อมที่เก็บจากการบริโภคสินค้าและบริการ ปัจจุบันอัตรา VAT ในประเทศไทยอยู่ที่ 7%' },
      { q: 'ถอด VAT คืออะไร?', a: 'ถอด VAT คือการคำนวณย้อนกลับจากราคาที่รวม VAT แล้ว เพื่อหาราคาก่อน VAT โดยใช้สูตร: ราคาก่อน VAT = ราคารวม VAT ÷ 1.07' },
      { q: 'สูตรคำนวณ VAT คืออะไร?', a: 'บวก VAT: ราคารวม = ราคาก่อน VAT × 1.07 | ถอด VAT: ราคาก่อน VAT = ราคารวม ÷ 1.07 | ยอด VAT = ราคาก่อน VAT × 0.07' },
      { q: 'ใช้สำหรับออกใบกำกับภาษีได้ไหม?', a: 'ได้ครับ ผลลัพธ์แสดงครบทั้ง 3 ยอดที่ต้องการในใบกำกับภาษี ได้แก่ มูลค่าสินค้า (ก่อน VAT), ภาษีมูลค่าเพิ่ม และยอดรวมทั้งสิ้น' },
    ],
    related: ['thai-tax-calculator', 'thai-baht-to-words', 'thai-number-to-text'],
    isNew: true,
  },
