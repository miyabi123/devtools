...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    shortDesc: 'Write and preview Markdown in real time',
    longDesc: 'Free online Markdown editor and previewer. Write Markdown on the left and see the rendered HTML preview on the right in real time. Supports all standard Markdown syntax including headings, bold, italic, tables, code blocks, blockquotes, and lists. Perfect for developers writing README files, documentation, and blog posts. All processing runs 100% client-side — your content never leaves your browser.',
    category: 'dev',
    keywords: ['markdown preview', 'markdown editor online', 'markdown viewer', 'markdown renderer', 'markdown to html', 'live markdown preview', 'readme preview', 'markdown formatter'],
    howTo: [
      'Type or paste your Markdown text in the left panel',
      'See the rendered preview update in real time on the right',
      'Use the toolbar shortcuts for common formatting',
      'Copy the rendered HTML output if needed',
    ],
    faq: [
      { q: 'What Markdown syntax is supported?', a: 'Supports standard Markdown including headings (#), bold (**), italic (*), tables, code blocks (```), blockquotes (>), ordered and unordered lists, links, and images.' },
      { q: 'Can I export the HTML output?', a: 'Yes — click the Copy HTML button to copy the rendered HTML to your clipboard.' },
  ...
  },
  {
    ...
    longDesc: 'Free online diff checker tool. Compare two text blocks side by side and highlight the differences instantly. Shows added, removed, and unchanged lines with color coding. Perfect for developers comparing code, writers reviewing document changes, and anyone who needs to spot differences between two versions of text. All processing runs 100% client-side — your text never leaves your browser.',
    category: 'dev',
    keywords: ['diff checker', 'text compare', 'compare two texts', 'diff tool online', 'text diff', 'code diff', 'find differences', 'compare files online', 'diff viewer'],
    howTo: [
      'Paste the original text in the left panel',
      'Paste the new or modified text in the right panel',
      'Click Compare to see the differences highlighted',
      'Green lines are additions, red lines are deletions',
    ],
    faq: [
      { q: 'What does the diff show?', a: 'Green highlighted lines are additions (in new text), red lines are deletions (removed from original), and white lines are unchanged.' },
      { q: 'Can I compare code?', a: 'Yes — the diff checker works with any plain text including code, JSON, markdown, and prose.' },
      { q: 'Is there a size limit?', a: 'No hard limit — but very large texts may be slower to process in the browser.' },
    ],
    related: ['markdown-preview', 'word-counter', 'json-formatter'],
    isNew: true,
  },
  {
    ...
    longDesc: 'Free online Lorem Ipsum generator. Generate classic Lorem Ipsum placeholder text by paragraphs, sentences, or words. Perfect for designers, developers, and content creators who need dummy text for wireframes, mockups, and prototypes. Also supports Thai placeholder text. All generation runs 100% client-side.',
    category: 'dev',
    keywords: ['lorem ipsum generator', 'placeholder text generator', 'dummy text generator', 'lorem ipsum online', 'random text generator', 'filler text', 'lorem ipsum paragraph', 'mockup text'],
    howTo: [
      'Select the type: paragraphs, sentences, or words',
      'Set the amount you need',
      'Choose between Classic Lorem Ipsum or Thai placeholder text',
      'Click Generate and copy the result',
    ],
    faq: [
      { q: 'What is Lorem Ipsum?', a: 'Lorem Ipsum is placeholder text derived from Latin, used in design and publishing to demonstrate visual layout without distracting real content.' },
      { q: 'Can I generate Thai placeholder text?', a: 'Yes — switch to Thai mode to generate Thai-language dummy text for Thai UI mockups.' },
      { q: 'What is the difference between paragraphs, sentences, and words?', a: 'Paragraphs generate multiple sentences grouped together. Sentences generate individual sentences. Words generate a specific number of random words.' },
    ],
    related: ['word-counter', 'markdown-preview', 'text-case-converter'],
    isNew: true,
  },
  {
    slug: 'pdf-base64',
